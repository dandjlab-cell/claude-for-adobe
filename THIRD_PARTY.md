...
| [ggml](https://github.com/ggml-org/ggml) `libggml`, `libggml-base`, `libggml-cpu-*`, `libggml-metal` | Tensor runtime for whisper.cpp; Metal GPU acceleration with CPU fallback | MIT, `licenses/ggml-LICENSE` |
