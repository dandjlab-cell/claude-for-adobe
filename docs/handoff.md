...
- The live 9:16 attempt below timed out before `audio_cut`; MUST/SHOULD remain unevaluated. The abandoned CPU transcription was terminated after the editor switched projects. No release.
