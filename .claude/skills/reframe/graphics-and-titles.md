...
4. The caption band is a Premiere track setting the panel cannot move yet. Say once where it should go (bottom safe-zone line, as low as it fits) and continue. `find_on_screen` on a caption word measures where it sits.
