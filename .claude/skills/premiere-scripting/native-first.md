...
| Caption band position / size | Captions track style, Essential Graphics | not scriptable through any panel API | `caption_style`: the saved project file (checkpoint, rewrite, reopen, read back) | Ours; the only route. Zone changes stay the editor's click. |
