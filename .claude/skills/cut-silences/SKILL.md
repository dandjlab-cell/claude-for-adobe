...
Before removing pauses on anything with more than one person or an audience: `sound_events` first. A pause that touches a laughter or applause segment is a beat, not dead air; leave it and say so.
