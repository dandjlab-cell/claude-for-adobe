...
1. `remove_silences` with `dry_run: true` (method `vad`, voice detection; no transcription needed). Default to social-tight: `min_silence_s: 0.35`, `pad_s: 0.05`. If the editor says "loose", "natural", or "leave some air", use `0.6` and `0.15`.
