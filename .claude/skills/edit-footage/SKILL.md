...
7. **Cut the talking head.** On Editorial, author thoughts and run `audio_cut` report then apply as above; use `keep_only` for the story. Preserve Cleanup. Report the new duration.
