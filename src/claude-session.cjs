...
function buildSystemPrompt(capabilities = "", agentName = "Claude") {
  return [
    ...
    "- Never work out by eye or by guessing what a tool computes: where a phrase is, talking head vs b-roll, what covers what, cut points.",
    ...
    "- Long jobs return 'started'; the panel says when they finish. Never poll.",
