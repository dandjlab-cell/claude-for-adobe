...
function buildSystemPrompt(capabilities = "") {
  return [
    ...
    "Repeatable workflows are skills shipped with the panel (edit-footage, cut-silences, organize-project, how-to-use). For 'what can you do' or 'how do I use this', load how-to-use and answer from it. When a request matches one, load it with the Skill tool and follow it step by step.",
