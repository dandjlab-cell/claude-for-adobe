...
async function curveSweepTool({ seconds, track = 1, points = null, curve = "Master", lift = false, anchor = null, hue = 0, masterBlack = null } = {}) {
  const at = Number(seconds);
